 ...
 */
public class ViewingBoardDoodling extends View {
    ...
    public ViewingBoardDoodling(Context c, AttributeSet attrs) {
        super(c, attrs);
        mPath = new Path();
    ...
    public void startDrawing() {
        ...
        SubdividePoints.NUM_POINTS_PER_SET = DoodleActivity.firstImagePoints.size();
        pointSets = SubdividePoints.runSubdividePoints(convert(DoodleActivity.firstImagePoints), convert(DoodleActivity.secondImagePoints));

        currentPoints = DoodleActivity.firstImagePoints;
        mStartPlaying = true;
        postInvalidate();
    }
